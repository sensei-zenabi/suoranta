...
// reaching a random ground level between `groundYMin` and `groundYMax`. Each
// raindrop chooses a new random ground level every time it respawns. Use this
// to add ambience to scenes.
